...
public class Ship extends Pirate {
  ...
  public void fillShip() {
    ...
    int numberOfPirates = randomNumber(113);
  ...
  private void party() {
    this.captain.setIntoxicationLevel(randomNumber(113));
    for (Pirate pirate : listOfPirates) {
      pirate.setIntoxicationLevel(randomNumber(113));
    }
  }
